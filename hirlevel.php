...
if ($sz1 && $sz2 ) {
	...
	$feedback = "<font color=#FF0000 >Köszönjük hírlevél jelentkezését!</font>";
      ...
      <td width="195" height="115" valign="top"><table width="195" height="115" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="195" valign="top"><table width="195" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="195" height="22" align="center" valign="top" class="szoveg3"><?=$feedback;?>
&nbsp;</td>
              </tr>
              <form name="ff" method="post" action="hirlevel.php" >
                <input type="hidden" name="send" value="ok">
                <tr>
                  <td height="62" valign="top"><table width="195" border="0" cellspacing="0" cellpadding="0">
                      <tr valign="middle">
                        <td width="110" height="27"><table width="108" height="19" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="108"><div align="left" class="szoveg4"><img src="nev.jpg" width="110" height="20"></div>
                              </td>
                            </tr>
                          </table>
                        </td>
                        <td width="85" height="27" class="szoveg3"><INPUT name=sz1 class="inputtype4" value="<?=$sz1;?>" size=16 >
                        </td>
                      </tr>
                      <tr valign="middle">
                        <td height="28"><table width="108" height="19" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <td height="28" class="szoveg3"><INPUT name=sz2 class="inputtype4" value="<?=$sz2;?>" size=16 >
                        </td>
                      </tr>
                      <tr valign="middle">
                        <td height="28"><table width="108" height="19" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="108"><div align="left" class="szoveg4"><img src="lakcim.jpg" width="110" height="20"></div>
                            </td>
                          </tr>
                        </table></td>
                        <td height="28" class="szoveg3"><INPUT name=sz3 class="inputtype4" id="sz3" value="<?=$sz3;?>" size=16 ></td>
                      </tr>
                    </table>
                  </td>
                </tr>
