...
switch ($sAction) {
	...
	case "U": // Update
		if (EditData($conn)) { // Update record
			$_SESSION[ewSessionMessage] = "Sikeres adatmódosítás";
			phpmkr_db_close($conn);
			ob_end_clean();
			header("Location: esemenylist.php");
			exit();
...
<p><span class="phpmaker">Szerkesztés Tábla: esemeny<br><br><a href="esemenylist.php">Vissza a listára</a></span></p>
...
<input type="text" name="x_kepek" id="x_kepek" size="20" maxlength="20" value="<?php echo htmlspecialchars(@$x_kepek) ?>">
	...
	<p>
	<input type="submit" name="btnAction" id="btnAction" value="Rögzítés">
</form>
