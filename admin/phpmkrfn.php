...
define("EW_RANDOM_KEY", "3Gbg8qge4&8Dw83K", true);
...
function ewAppRoot() {
	...
	// use the document root if available
	$Path = @$_SERVER["DOCUMENT_ROOT"]; 
	if (empty($Path)) $Path = @$_ENV["DOCUMENT_ROOT"];
	// if empty, use root relative path
	if (empty($Path)) {
	...
	// use custom path, uncomment the following line and enter your path
